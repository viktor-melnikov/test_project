...
<head>
    ...
    <link rel="stylesheet" href="{{ asset_dist('css/build.min.css') }}">
</head>
<body>
    ...
    <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
        <h1 class="display-4 pb-md-4">Дествия с пользователями/ИНН</h1>
        <p>
            <a href="#" data-toggle="modal" data-target="#addUser" class="btn btn-outline-dark mr-4">Добавить пользователя</a>
            <a href="#" data-toggle="modal" data-target="#addMoney" class="btn btn-outline-success mr-4">Зачислить средства пользователю</a>
            <a href="#" class="btn btn-outline-warning">История операций</a>
        </p>
    </div>
    ...
    <script src="{{ asset_dist('js/app.min.js') }}"></script>
