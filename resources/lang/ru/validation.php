...
return [
    ...
    */
    ...
    'exist_nominal_prize'  => 'Не все вознаграждения существуют. Проверьте правильность выбранных призов',
    'check_user_points'    => 'У вас недостаточно баллов',
    'is_numeric_nominals'  => 'Кол-во баллов/карт должно быть числом и больше или равно 0.',

    'not_valid_phone' => 'Номер телефона имеет неверный формат',
    'check_balance'   => 'У пользователя недостаточно средств для перевода',
    'check_deposit'   => 'Для корректного распределения средств между пользователями укажите сумму :sum',
    'is_float'        => 'Некорректная сумма, нужно: 13.23 (число с точкой)',
